...
if(Ext.ux.TabCloseMenu)
{
	Ext.apply(Ext.ux.TabCloseMenu.prototype, {
    	...
    	showCloseAll: true,
    	closeAllTabsText: 'Cerrar Todos'
	});
}

/*!
 * Manejo de lenguajes en las pantallas
 * Copyright(c) 2011 Sagos Software.
 * pcruz@sagos.com.mx
 * 2011-11-01


if(companiasClass) {
    Ext.apply(companiasClassUi.prototype, {
        winTitle    : 'LxTC - Mantenimeinto a Compañías', 
	    tab1Title   : 'Datos',
    	tab2Title   : 'Consulta',
		nuevo       : 'Nuevo',
		guardar     : 'Guardar',
		...
		estatus     : 'Estatus', 
    	exportar    : 'Exportar Consulta',
		msg         : 'Esta seguro que desea eliminar la Compañía Seleccionada?'
    });
}

if(LxsTerminalesClass) {
    Ext.apply(LxsTerminalesClassUi.prototype, {
    winTitle    : 'LxTC - Mantenimiento a Terminales', 
	tab1Title   : 'Datos',
    tab2Title   : 'Consulta',
	nuevoLbl    : 'Nuevo',
	guardarLbl  : 'Guardar',
	eliminarLbl : 'Eliminar',
	buscarLbl   : 'Buscar',
	cancelarLbl : 'Cancelar', 
	ipLbl       : 'Dirección IP', 
	puertoLbl   : 'Puerto', 
	descLbl     : 'Descripción',
	modeloLbl   : 'Modelo',
	usrLbl      : 'Usuario (FTP)',
	pwdLbl      : 'Contraseña (FTP)',
	monitorLbl  : 'Monitorear',
	sincFecLbl  : 'Sincronizar Fecha',
	estatusLbl  : 'Estatus',
	exportarLbl : 'Exportar Consulta',
	msg         : 'Esta seguro que desea eliminar la Terminal Seleccionada?'
    });
}

if(LxsGruposClass) {
    Ext.apply(LxsGruposClassUi.prototype, {
    winTitle    : 'LxTC - Mantenimiento a Grupos', 
	tab1Title   : 'Datos',
    tab2Title   : 'Consulta',
	nuevoLbl    : 'Nuevo',
	guardarLbl  : 'Guardar',
	...
	estatusLbl  : 'Estatus',
	exportarLbl : 'Exportar Consulta',
	msg         : 'Esta seguro que desea eliminar el Grupo Seleccionado?'
    });
}

if(LxsUsuariosClass) {
    Ext.apply(LxsUsuariosClassUi.prototype, {
    winTitle    : 'LxTC - Mantenimiento a Usuarios', 
	tab1Title   : 'Datos',
    tab2Title   : 'Consulta',
	gralTitle   : 'Datos Generales',
	segTitle    : 'Seguridad',
	nuevoLbl    : 'Nuevo',
	guardarLbl  : 'Guardar',
	eliminarLbl : 'Eliminar',
	...
	estatusLbl  : 'Estatus',
	perfilLbl   : 'Perfil',
	authLbl     : 'Autenticación',
	pinLbl      : 'Código PIN',
	barLbl      : 'Código de Barras',
	magLbl      : 'Banda Magnética',
	fpLbl       : 'Huella',
	rfidLbl     : 'Proximidad',
	comLbl      : 'Puerto COM',
	exportarLbl : 'Exportar Consulta',
	msg         : 'Esta seguro que desea eliminar el Usuario/Empleado Seleccionado?'
    });
} */